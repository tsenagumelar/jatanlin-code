...
export type InsertTransactWimSessionMutation = { insert_transact_wim_session_one?: { id: any, session_name?: string | null, status: string, started_at: any, site_id: any, is_dummy: boolean } | null };
