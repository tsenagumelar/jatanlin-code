  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-5 py-10 text-slate-950">
      <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-3 text-2xl font-bold">Reset Kata Sandi</h1>
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Halaman reset kata sandi v3 sudah siap. Permintaan reset dan
          konfirmasi kata sandi akan diimplementasikan pada fase berikutnya.
        </p>
        <Link
          href="/login"
