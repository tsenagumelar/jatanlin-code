...
VALUES
	...
	('SERVICE', 'NATS_URL', 'nats://nats:4222', 'url', 'NATS URL', 'NATS broker URL used by queue workers.', false, 230),
	...
	('ANPR_FTP', 'ANPR_FTP_HOST', 'ftp-local:21', 'string', 'ANPR FTP Host', 'FTP host and port for ANPR files.', false, 410),
	('ANPR_FTP', 'ANPR_FTP_USER', 'ftpuser', 'string', 'ANPR FTP Username', 'Username for ANPR FTP access.', false, 420),
	('ANPR_FTP', 'ANPR_FTP_PASS', 'ftppass', 'password', 'ANPR FTP Password', 'Password for ANPR FTP access.', true, 430),
	('ANPR_FTP', 'ANPR_FTP_DIR', 'anpr', 'path', 'ANPR FTP Directory', 'Directory where ANPR XML/image files are stored.', false, 440),
	...
	('AXLE_FTP', 'AXLE_FTP_HOST', 'ftp-local:21', 'string', 'AXLE FTP Host', 'FTP host and port for axle capture files.', false, 510),
	('AXLE_FTP', 'AXLE_FTP_USER', 'ftpuser', 'string', 'AXLE FTP Username', 'Username for axle FTP access.', false, 520),
	('AXLE_FTP', 'AXLE_FTP_PASS', 'ftppass', 'password', 'AXLE FTP Password', 'Password for axle FTP access.', true, 530),
	('AXLE_FTP', 'AXLE_FTP_DIR', 'axle', 'path', 'AXLE FTP Directory', 'Directory where axle XML/image files are stored.', false, 540),
	...
	('MINIO', 'ANPR_MINIO_ENDPOINT', 'minio:9000', 'string', 'ANPR MinIO Endpoint', 'Object storage endpoint for ANPR assets.', false, 610),
	...
	('MINIO', 'AXLE_MINIO_ENDPOINT', 'minio:9000', 'string', 'AXLE MinIO Endpoint', 'Object storage endpoint for axle assets.', false, 660),
	...
	('MINIO', 'ATTACHMENT_MINIO_ENDPOINT', 'minio:9000', 'string', 'Attachment MinIO Endpoint', 'Object storage endpoint for attachments.', false, 710),
	...
	('VEAM', 'VEAM_USB_SCAN_PATHS', '/host/usb,/host/Volumes,/Volumes', 'string', 'VEAM USB Scan Paths', 'Comma separated mount roots used to find USB license files.', false, 940),
