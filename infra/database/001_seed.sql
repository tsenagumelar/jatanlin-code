...
VALUES
  ...
  ('ANPR_FTP', 'ANPR_FTP_DIR', 'anpr', 'path', 'ANPR FTP Directory', 'Docker FTP directory for ANPR files', false, true, 50, true, false),
  ('AXLE_FTP', 'AXLE_FTP_HOST', 'ftp-local:21', 'string', 'AXLE FTP Host', 'Docker FTP endpoint for AXLE watcher', false, true, 60, true, false),
  ...
  ('AXLE_FTP', 'AXLE_FTP_DIR', 'axle', 'path', 'AXLE FTP Directory', 'Docker FTP directory for AXLE files', false, true, 90, true, false),
