...
const menuSections: V3MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Live View",
        href: "/v3/monitoring/live-view",
        icon: <Video24Regular />,
        activeIcon: <Video24Filled />,
      },
      {
        label: "LED Display",
        href: "/v3/monitoring/led-display",
        icon: <Tv24Regular />,
  ...
  },
  {
    ...
    items: [
      {
        label: "Jatanlin",
        href: "/v3/transaction/jatanlin",
        icon: <CardUi24Regular />,
        activeIcon: <CardUi24Filled />,
      },
      {
        label: "Data Center",
        href: "/v3/transaction/data-center",
  ...
  },
  {
    ...
    items: [
      {
        label: "User",
        href: "/v3/master-data/user",
        icon: <People24Regular />,
        activeIcon: <People24Filled />,
      },
      {
        label: "Vehicle Classes",
        href: "/v3/master-data/vehicle-classes",
