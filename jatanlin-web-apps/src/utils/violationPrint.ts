...
.sticker {
  width: 100%; min-height: 95mm;
  background: #d90429;
  border: 2mm solid #2b2d42;
  border-radius: 2mm; color: #fff; position: relative;
  display: flex; flex-direction: column; align-items: center;
  text-align: center; padding: 26mm 2.5mm 17mm;
}
.title { font-size: 6mm; line-height: .96; font-weight: 900; letter-spacing: .1mm; margin: 1mm 0 5mm; max-width: 52mm; }
.subtitle { display: flex; min-height: 24mm; flex-direction: column; justify-content: center; gap: 1mm; font-size: 3.9mm; line-height: 1.05; font-weight: 900; color: #ffea00; text-shadow: 0 1px 0 rgba(0,0,0,.25); }
...
.footer-text { max-width: 35mm; text-align: left; }
...
<body onload="window.focus(); window.print();">
  <div class="page">
    <div class="sticker">
      ...
      <div class="subtitle">
        <span ${
          isDimension || isBoth ? 'style="text-decoration:underline"' : ""
        }>OVER DIMENSION</span>
        <small> / </small>
        <span ${
