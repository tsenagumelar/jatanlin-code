...
function proxiedStreamUrl(device: Exclude<DeviceKey, "wim">, streamUrl: string) {
  ...
  return `/api/device-stream?${params.toString()}`;
}
...
function LiveViewPanel({ feed }: { feed: LiveFeed }) {
  ...
  return (
    <section className="relative min-h-[260px] overflow-hidden rounded-lg border border-slate-800 bg-slate-950 shadow-sm">
      ...
      <div className="flex min-h-[calc(100vh-12rem)] flex-col rounded-lg border border-slate-200 bg-white p-3 shadow-sm sm:p-4">
        ...
        <section className="grid min-h-0 flex-1 gap-3 xl:grid-cols-2">
          ...
          <div className="grid min-h-0 gap-3 xl:grid-rows-2">
            ...
            <section className="min-h-[260px] overflow-hidden rounded-lg border border-slate-800 bg-slate-900 p-4">
