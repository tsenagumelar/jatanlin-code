...
VALUES
  ...
  ('MINIO', 'ANPR_MINIO_ENDPOINT', 'localhost:19000', 'string', 'ANPR MinIO Endpoint', 'Local MinIO endpoint for ANPR bucket', false, true, 100, true, false),
  ...
  ('MINIO', 'AXLE_MINIO_ENDPOINT', 'localhost:19000', 'string', 'AXLE MinIO Endpoint', 'Local MinIO endpoint for AXLE bucket', false, true, 150, true, false),
  ...
  ('MINIO', 'ATTACHMENT_MINIO_ENDPOINT', 'localhost:19000', 'string', 'Attachment MinIO Endpoint', 'Local MinIO endpoint for attachment bucket', false, true, 200, true, false),
  ...
  ('WEIGHING', 'WEIGHING_TRIGGER_URL', 'http://localhost:5001/ws/wim/anpr-capture', 'url', 'Weighing Trigger URL', 'Local WB agent trigger endpoint', false, true, 250, true, false),
