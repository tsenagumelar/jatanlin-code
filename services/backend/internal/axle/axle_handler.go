...
func (p *AxleProcessor) SetSessionService(service *session.SessionService) {
...
func (p *AxleProcessor) processBatchInSession(ctx context.Context, c *ftp.ServerConn, session *session.ActiveSession) bool {
